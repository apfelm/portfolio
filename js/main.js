window.addEventListener('DOMContentLoaded', (event) => {
    $("#home-high-text2,#home-high-text4").each(function(){
        $(this).parent().width($(this).width());
        $(this).parent().height($(this).height());
    });
    setTimeout(function () {
        $("#home-high-text1").animate({bottom:'150px'}, 200).css('position','absolute');
        $("#home-high-text3").animate({bottom:'150px'}, 200).css('position','absolute');
        $("#home-high-text2").animate({bottom:'0'}, 200);
        $("#home-high-text4").animate({bottom:'0'}, 200);
    }, 3000);
});
